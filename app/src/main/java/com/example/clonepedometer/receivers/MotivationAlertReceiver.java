...
import static com.example.clonepedometer.services.AbstractStepDetectorService.CHANNEL_ID;
...
import com.example.clonepedometer.MainActivity;
...
public class MotivationAlertReceiver extends WakefulBroadcastReceiver {
    ...
    private void motivate() {
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(context.getApplicationContext())
                ...
                .setLights(ContextCompat.getColor(context, R.color.teal_200), 1000, 1000);
        // Notify
